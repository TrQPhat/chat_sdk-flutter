...
dependencies:
  tqp_chat_sdk:
    git:
      url: https://github.com/TrQPhat/chat_sdk.git
...
Sao chép
Chỉnh sửa
import 'package:tqp_chat_sdk/tqp_chat_sdk.dart';
...
Repository: https://github.com/TrQPhat/chat_sdk

Issue Tracker: https://github.com/TrQPhat/chat_sdk/issues
```
